...
mkdir output_files
#echo '.x MuMu/MuMu_reco_data.C('$2','$3', "EOS_files/2018/SingleMuon_files.txt", 2018);' > cmd.txt
#echo '.x ElEl/ElEl_reco_data.C('$2','$3', "EOS_files/2018/SingleElectron_files.txt", 2018);' > cmd.txt
##echo '.x MuMu/MuMu_reco_mc.C('$2','$3', "EOS_files/2017/DY_files.txt", 2017);' > cmd.txt
#echo '.x EMu/EMu_reco_background.C('$2','$3', "EOS_files/2018/TTbar_files.txt", 2018);' > cmd.txt
#echo '.x Misc/Select_gen_level.C('$2','$3', "EOS_files/2016/DY_files.txt", 2016);' > cmd.txt
#echo '.x FakeRate/SingleElectron_mc_contam_fake_rate.C('$2','$3', "EOS_files/2016/diboson_files.txt", 2016);' > cmd.txt
echo '.x SFs/Btag_efficiency.C('$2','$3', "EOS_files/2018/TTbar_files.txt", 2018);' > cmd.txt
