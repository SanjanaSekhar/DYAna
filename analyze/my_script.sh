...
mkdir output_files
#echo '.x ElEl/ElEl_reco_data.C('$2','$3', "EOS_files/2016/SingleElectron_files.txt", 2016);' > cmd.txt
#echo '.x FakeRate/SingleElectron_data_measure_fake_rate.C('$2','$3', "EOS_files/2016/SingleElectron_files.txt", 2016);' > cmd.txt
