...
mkdir output_files
#echo '.x MuMu/MuMu_reco_background.C('$2','$3', "EOS_files/2017/TTbar_files.txt", 2017);' > cmd.txt
#echo '.x FakeRate/SingleElectron_mc_contam_fake_rate.C('$2','$3', "EOS_files/2016/diboson_files.txt", 2016);' > cmd.txt
echo '.x EMu/EMu_reco_background.C('$2','$3', "EOS_files/2017/TTbar_files.txt", 2017);' > cmd.txt
