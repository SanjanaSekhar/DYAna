...
//    for(int year=2016;year<=2018;year++){
        ...
        int year = 2017;
        char fout_name[200];
       // sprintf(fout_name,"combine/templates/LQm%i_R2RLue_gen_templates%i_060622.root",int(m_LQ),year%2000);
        ...
        char lhe_name[200];
        sprintf(lhe_name,"../analyze/root_files/LQ_m%i_MGevents_ylq1_041222.root",int(m_LQ));
