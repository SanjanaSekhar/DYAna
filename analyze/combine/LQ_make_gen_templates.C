...
//    for(int year=2016;year<=2018;year++){
        ...
        int year = 2017;
        char fout_name[200];
        sprintf(fout_name,"combine/templates/LQm%i_R2RLde_gen_templates%i_060622.root",int(m_LQ),year%2000);
       // sprintf(fout_name,"combine/templates/LQm%i_SM_gen_templates%i_060622.root",int(m_LQ),year%2000);
