...
mask_params="mask_Y16_ee16_ss=1,mask_Y17_ee17_ss=1,mask_Y18_ee18_ss=1,mask_Y16_ee16=1,mask_Y17_ee17=1,mask_Y18_ee18=1"
...
#idx=0
    ...
    if $do_plot; then
        combine -M FitDiagnostics $workspace --plot --saveWorkspace --skipBOnlyFit --robustFit 1 #-v 10
        rm -r $plotdir
        mkdir $plotdir
        mv *.png $plotdir
    else
        combine -M FitDiagnostics $workspace --saveWorkspace --skipBOnlyFit --robustFit 1 --setParameters #-v 10
    fi
