		...
		# Otherwise it's a TH1 hopefully
			...
			# Otherwise...
				...
				if not logy: 
					...
					legends.append(TLegend(0.4,0.7,0.95,0.77+0.02*(len(bkglist[0])+len(signals))))
...
label_color_map['gam'] = ("#gamma#gamma #rightarrow %s " %("#mu#mu" if options.chan=="mumu" else "ee"), gamgam_co)
