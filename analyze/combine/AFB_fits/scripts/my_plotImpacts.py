...
parser.add_argument('--height', type=int, default=1000, help='Canvas height, in pixels')
...
plot.ModTDRStyle(l=args.left_margin, r = right_margin , b=0.10, width=(1000 if args.checkboxes else 1000), height=args.height)
...
for page in xrange(n):
    ...
    plot.DrawCMSLogo(pads[0], 'CMS', args.cms_label, 0, 0.45, 0.00, 0.00)
