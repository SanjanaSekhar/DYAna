...
void merge_workspaces(){
    ...
    const TString f1_s("combine/templates/test_2016.root");
    const TString fout_s("combine/templates/merge_test_2016.root");
    //const TString f1_s("combine/templates/mar2_blind_2018.root");
    //const TString fout_s("combine/templates/mar2_blind_2018_merge.root");
    TFile *f1 = TFile::Open(f1_s, "READ");
    TFile *fout = TFile::Open(fout_s, "RECREATE");
    char dirname[40];


    char *sys_base = "root://131.225.204.161:1094//store/user/oamram/Condor_outputs/templ18_sys_mar2";
    char *pdf_base = "root://131.225.204.161:1094//store/user/oamram/Condor_outputs/templ18_pdf_mar2";
...
*/
    fs.push_back("output_files/sys_test.root");
