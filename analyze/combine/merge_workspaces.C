...
void merge_workspaces(){
    ...
    const TString f1_s("combine/templates/april21_2018.root");
    const TString fout_s("combine/templates/april21_merge_2018.root");
    TFile *f1 = TFile::Open(f1_s, "READ");
    TFile *fout = TFile::Open(fout_s, "RECREATE");
    char dirname[40];


    char *sys_base = "root://cmseos.fnal.gov//store/user/oamram/Condor_outputs/templ18_sys_april21";
    char *pdf_base = "root://cmseos.fnal.gov//store/user/oamram/Condor_outputs/templ18_pdf_april21";
