...
void LQ_read_lhes(){
    ...
    t1->SetDirectory(0);
    string f1("/uscms/home/ssekhar/nobackup/CMSSW_10_5_0/src/LQ_Analysis/DYAna/analyze/SLQ/LQ53_NNPDF30/R17_LQ23_2TeV_1_no_jets.lhe");
//    string f1("/uscms/home/ssekhar/nobackup/CMSSW_10_5_0/src/LQ_Analysis/DYAna/analyze/SLQ/tag_SM_pythia8_BasicReco.lhe");
   ...
   // TFile *fout1 = TFile::Open("root_files/LQ_SM_test2_020122.root", "RECREATE");
    TFile *fout1 = TFile::Open("root_files/LQde_m2000_MGevents_ylq1_nojets_060622.root", "RECREATE");
    fout1->cd();
    t1->Write();
    fout1->Close();
    delete t1;
