...
void LQ_read_lhes(){
    ...
    t1->SetDirectory(0);
//    string f1("/uscms/home/ssekhar/nobackup/CMSSW_10_5_0/src/LQ_Analysis/DYAna/analyze/SLQ/tag_1TeV_pythia8_BasicReco.lhe");
   ...
   // TFile *fout1 = TFile::Open("root_files/LQ_m1000_test2_020122.root", "RECREATE");
    fout1->cd();
    t1->Write();
    fout1->Close();
    delete t1;
