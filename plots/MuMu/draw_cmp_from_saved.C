...
leg3->AddEntry(gg_m, "#gamma#gamma #rightarrow #mu#mu", "f");
    ...
    std::tie(c_m, p_m) = make_stack_ratio_plot(data_m, LQu_m, LQu_vec_m, m_stack, leg1, "m", "m_{#mu#mu} (GeV)",y_ax_label, plot_label, hmax, logy, logx, draw_sys_uncs, ratio_range, false, hmin);
    ...
    std::tie(c_rap, p_rap) = make_stack_ratio_plot(data_rap, LQu_rap, LQu_vec_rap, rap_stack, leg3, "rap", "Dimuon rapidity",y_ax_label, plot_label, hmax, logy, logx, draw_sys_uncs, ratio_range);
