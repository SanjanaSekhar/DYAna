...
void draw_samesign_cmp(){
    ...
    std::tie(c_m, p_m) = make_stack_ratio_plot(data_m, m_stack, leg1, "m", "M_{#mu#mu} (GeV)", "", plot_label, -1., true, logx, draw_sys_uncs);
    ...
    std::tie(c_pt, p_pt) = make_stack_ratio_plot(data_pt, pt_stack, leg3, "pt", "dimuon pt (GeV)","", plot_label, -1.,  true, logx, draw_sys_uncs);
    ...
    std::tie(c_phi, p_phi) = make_stack_ratio_plot(data_phi, phi_stack, leg5, "phi", "dimuon #phi","", plot_label, -1., true, logx, draw_sys_uncs);
