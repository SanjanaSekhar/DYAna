...
void draw_cmp_from_saved(){
    ...
    leg1->AddEntry(top_comb_m, "t#bar{t} + Single Top", "f");
    ...
    sprintf(plt_file, "%sElEl%i_m_cmp.png", plot_dir, year % 2000);
    ...
    sprintf(plt_file, "%sElEl%i_cost_cmp.png", plot_dir, year % 2000);
    ...
    sprintf(plt_file, "%sElEl%i_rap_cmp.png", plot_dir, year % 2000);
