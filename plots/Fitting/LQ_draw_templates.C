     ...
     // for(int i=i_start;i<=i_end;i++)
      // {
        ...
        setup_all_SFs(year);
            ...
            sprintf(mu_fname1, "%s/Mu%i_NLO_SM.png", plot_dir, year%2000);
        ...
        */
        ...
        if(draw_electrons){
            ...
            sprintf(el_fname1, "%s/El%i_NLO_SM.png", plot_dir, year%2000);
            ...
            */
            ...
            //h1_elel_LQpure->SetMaximum(h1_elel_LQint->GetMaximum()*1.2);
