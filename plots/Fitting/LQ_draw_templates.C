     ...
     // for(int i=i_start;i<=i_end;i++)
      // {
        ...
        setup_all_SFs(year);
            ...
            sprintf(mu_fname1, "%s/Mu%i_SMconsistencychk_m%i.png", plot_dir, year%2000,int(m_LQ));
        ...
        */
        ...
        if(draw_electrons){
            ...
            sprintf(el_fname1, "%s/El%i_SMconsistencychk_m%i.png", plot_dir, year%2000,int(m_LQ));
