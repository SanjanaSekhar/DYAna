...
const int n_m_bins = 5;
Float_t m_bins[] = { 250.,320., 510., 700., 1000., 14000.};
const int n_pt_bins = 7;
Float_t pt_bins[] = {0., 10., 20., 30., 50., 70., 100., 10000. };

//Float_t amc_alpha[n_m_bins] =        { 0.030, 0.018, 0.012};
//Float_t amc_alpha_unc[n_m_bins] =    { 0.005, 0.007, 0.007};
